                ...
                <div class="col-md-12">
                    ...
                    if($result = $pdo->query($sql)){
                        if($result->rowCount() > 0){
                            echo "<table class='table table-bordered table-striped'>";
                                ...
                                while($row = $result->fetch()){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            echo "<a href='addcart.php?id=". $row['id'] ."' title='Adicionar ao carrinho' data-toggle='tooltip'><span class='glyphicon glyphicon-shopping-cart'></span></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";
                            ...
                            echo "<p class='lead'><em>Nada encontrado.</em></p>";
                        }
                    } else{
